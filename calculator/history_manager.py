'''
The below history code is good 
'''
...
'''
This below code is to test and see if hostory will be stored in.csv file 
history is stored so this code is good 
'''
...
Below code is to see if I can fix the error i get via test 
...
class HistoryManagerFacade:
    ...
    def __init__(self, filename='calculator_history.csv'):
